...
Git.prototype.switchToBranch = function () {
    var self = this;
    var arg = arguments;
    return _init.call(self).then(function () {
            ...
            if ("origin" == currentName) {
                ...
                return _execAsync.call(self, {
                    ...
                    return _execAsync.call(self, {
                        ...
                        return Promise.each(branchNames.split(/(\r\n|\n|\r)/gm), function (branchName) {
                            var remoteBranch = branchName.trim();
                            if (remoteBranch) {
...
var _branchExists = function (checkBranchName) {
    ...
    return _execAsync.call(self, {
        ...
        return branchNames.split(/(\r\n|\n|\r)/gm).reduce(function (prev, name) {
