...
var CICD = (function () { 
    ...
    var getDisplayValue = (element) => {
        if (element === undefined)
            return undefined;
        return (element.display_value !== undefined) ? element.display_value.trim() : getValue(element);
    };
    ...
    var configureProjectFile = function (files, ctx) {
        ...
        return Promise.try(() => {
            ...
            return Promise.try(() => {
                return (testConfig.atf.updateSetOnly) ? project.getTestSuites(config.branchName) : this.getApplicationTestSuites(ctx);
            }).then((testSuites) => {
            ...
            return Promise.try(() => {
                return (testConfig.atf.updateSetOnly) ? project.getTests(config.branchName) : this.getApplicationTests(ctx);
            }).then((tests) => {
                ...
                if (testConfig.atf.tests.length) {
                    /*
        ...
        return Promise.try(() => {
            ...
            */
            ...
            return Promise.try(() => {
                ...
                return configureProjectFile.call(this, files, ctx).then(() => files);
            });        
            ...
            return Promise.try(() => {
                ...
                */
                return getFilesByUpdatedBy(files.deletedFiles).then((fileByUpdatedBy) => { // sort deleted files update by user
                ...
                /*
                    group files by user and commit individually
                */
                return getFilesByUpdatedBy(files.updatedFiles).then((fileByUpdatedBy) => { // sort updated files update by user
