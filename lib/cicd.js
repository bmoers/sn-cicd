        ...
        return Promise.try(() => {
            ...
            return Promise.try(() => {
                ...
                return client.get({
                    ...
                    qs: {
                        'sysparm_query': `update_set.base_update_set=${config.updateSet.sys_id}^ORupdate_set=${config.updateSet.sys_id}^ORDERBYname^ORDERBYDESCsys_recorded_at`,
                    ...
                    return Promise.each(results, (result) => {
                        ...
                        // base_update_set query results need to be made unique
                        if (nameCache.has(result.name))
                            return;
                        
                        nameCache.set(result.name, true);
