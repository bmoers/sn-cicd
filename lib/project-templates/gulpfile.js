...
// use custom gulp-jsdoc3.js instead of 'gulp-jsdoc3'
const jsdoc3 = require('./gulp-jsdoc3.js');
...
const build = async function () {
    ...
    */
    ...
    const buildDone = async function buildDone() {
        ...
        console.log(`Remove directory '${config.tempDir}'`);
