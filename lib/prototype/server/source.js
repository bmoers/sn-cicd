...
module.exports = function () {
    ...
    router.get(`${UPDATE_SET_XML_COUNT}/:commitId`, (req, res) => {
        ...
        return self.db.run.findOne({
            ...
            return new EventBusJob({ name: 'extractUpdateSet', background: false }, { commitId: run.commitId, count: true }).then((job) => {
    ...
    router.post(`${UPDATE_SET_XML_DATA}/`, (req, res) => {
        ...
        return self.db.run.findOne({
            ...
            return new EventBusJob({ name: 'extractUpdateSet', background: false }, { commitId: run.commitId, xmlSysIds }).then((job) => {
