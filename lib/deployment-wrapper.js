        ...
        */
        ...
        return self.db.deployment.findOne({
            ...
            return self.db.deployment.insert({
                ...
                return new EbQueueJob({ name: 'deployUpdateSet', background: true }, { id: deployment._id, commitId, from: sourceHostName, to: targetHostName, deploy, fromGit: git }, logger).then(() => {
